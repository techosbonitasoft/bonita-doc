...
If you need the SSO to work with the APIs you can update the file `BUNDLE_HOME/webapps/bonita/WEB-INF/web.xml` to add the following resources to the URL Mappings of `AuthenticationFilter` and `KerberosFilter`:
